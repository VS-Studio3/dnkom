			...
			switch($order) {
				case 1:	if ($showvkontakte) { 
					...
					#vkgroup div, #vkgroup iframe { height: {$height}px!important; }
						...
						<li style="list-style-type: none;" class="active"><a data-target="#vkgroup" href="#" data-toggle="tab">ВКонтакте</a></li>
	
					
HTML;
						} else {$scriptPage .='';} break;
				case 2:	if ($showok) { $scriptPage .= <<<HTML
					<li style="list-style-type: none;"><a href="#" data-target="#okgroup" data-toggle="tab">Однокласники</a></li>
HTML;
						} else {$scriptPage .='';} break;
				case 3:	if ($showfacebook) { $scriptPage .= <<<HTML
					 <li style="list-style-type: none;"><a href="#" data-target="#fbgroup" data-toggle="tab">Facebook</a></li>
HTML;
						} else {$scriptPage .='';} break;
