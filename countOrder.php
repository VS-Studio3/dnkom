        ...
        if ('<?php echo $calculatorCookieLementsList[2]; ?>' != '') {
            ...
            for (var i = 0; i < analizesList.length; i++) {
                if (analizesList[i] != '') {
                    ...
                    for (k in elementsObject['f65d26df-3ce1-49a2-80e4-8e2fa535e236']) {
                        if (elementsObject['f65d26df-3ce1-49a2-80e4-8e2fa535e236'].hasOwnProperty(k))
                        analiz.proizvoditel += '<img src="' + elementsObject['f65d26df-3ce1-49a2-80e4-8e2fa535e236'][k]['file'] + '">';
                    }
            ...
            for (var i = 0; i < analizesDataList.length; i++) {
             ...
             '<div class="img">' + analizesDataList[i].proizvoditel + '</div>' +
             ...
             var summary = 0;
             if (skidka == 0)
             jQuery('.full_description.stoimost-zakaza .inner div:eq(2)').html('Сумма: ' + generalSumma + ' руб.');
             else {
