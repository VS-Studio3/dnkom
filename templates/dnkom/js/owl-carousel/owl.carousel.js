...
(function (jQuery, window, document) {
    ...
    var Carousel = {
        init : function (options, el) {
            ...
            base.$elem = jQuery(el);
            base.options = jQuery.extend({}, jQuery.fn.owlCarousel.options, base.$elem.data(), options);
        ...
        buildControls : function () {
            ...
            if (base.options.navigation === true || base.options.pagination === true) {
                base.owlControls = jQuery("<div class=\"owl-controls\"/>").toggleClass("clickable", !base.browser.isTouch).appendTo(base.$elem);
            }
        ...
        checkPagination : function () {
            ...
            base.paginationWrapper.find(".owl-page").each(function () {
                if (jQuery(this).data("owl-roundPages") === jQuery(base.$owlItems[base.currentItem]).data("owl-roundPages")) {
        ...
        autoHeight : function () {
            var base = this,
                $currentimg = jQuery(base.$owlItems[base.currentItem]).find("img"),
                iterations;

            function addHeight() {
                var $currentItem = jQuery(base.$owlItems[base.currentItem]).height();
        ...
        onVisibleItems : function () {
            ...
            for (i = base.currentItem; i < base.currentItem + base.options.items; i += 1) {
                ...
                if (base.options.addClassActive === true) {
                    jQuery(base.$owlItems[i]).addClass("active");
                }
            }
